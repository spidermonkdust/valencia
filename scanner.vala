...
enum Token {
	...
	// keywords
	ABSTRACT, CLASS, CONST, CONSTRUCT, DELEGATE, ENUM, FOREACH, INLINE, INTERFACE, NAMESPACE, NEW,
    OUT, OVERRIDE, OWNED, PRIVATE, PROTECTED, PUBLIC, REF, RETURN, SIGNAL, STATIC, STRUCT, UNOWNED,
    USING, VIRTUAL, WEAK
}
